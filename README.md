...
- **Fotoğraflar**: model `[FOTO:id]` etiketiyle gönderir. Sahne seti `ben, ayna, yatak, balkon, dus, otel, taksi, saten`; çıplak/tease seti `gomlek, etek, dantel, acik, dovme` — çıplak/meme/iç çamaşırı istekleri persona gereği HEP bu ikinci setten, anın ısısına göre seçilir (erken tease → gomlek/dovme/etek, ısınınca → dantel, yanarken → acik); jenerik "foto" isteği ısıyla tırmanır. Tur başına en fazla bir foto; gönderilen id'ler ilişki dijestine `[foto:id]` olarak yazılır, tekrar gönderim yapılmaz. Çipler temalı fotoğrafı garanti eder. Profilde galeri; göndermedikleri kilitli.
