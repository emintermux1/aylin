...
- Composer bir not defteri alanı gibi; tetikleyiciler (`devam · otel · duş · balkon · taksi · ofis · sesli`) şeker hap değil, ince altı çizili metin. `devam` yönetmen çipidir: sahneyi bir adım Asya ilerletir.
